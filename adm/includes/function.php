    ...
    function bodyback(){
        ...
        <div id="main">
            <div class="inner">
                <h1>Administração</h1>
                <header id="inner">
                    <p>Em tudo que existe há a administração seja ela do que for.</p>
                </header>
                ...
                <section class="tiles">
                    ...
                    <article class="style5">
                        ...
                        <a href="listaestabelecimentos.php">


                            <p>
                                <small>
                            <h2>administração Estabelecimentos</h2>
                                </small>
                            </p>
                        </a>
                    </article>
                    ...
                    <article class="style6">
                        ...
                        <a href="listaslideshow.php?inicio=true">
