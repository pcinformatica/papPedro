...
?>
    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                <h1>Página Pontos de Interesse- Administração</h1>
...
?>
   ...
   <div class="d-grid gap-2 d-md-flex justify-content-md-end" data-toggle="modal" data-target="#exampleModal">
    <a href="#" class="btn btn-primary pull-right h2">Novo ponto de interesse</a>
   ...
   <table class="table table-striped">";
      <thead>
        <tr>
            <th scope="col"></th>
          <th scope="col">ID</th>
          <th scope="col">Nome do ponto de interesse</th>
          <th scope="col">Nome da Imagam</th>
      ...
      <tbody>
        ...
        while ($dados=mysqli_fetch_array($result)) {
            ...
            echo "<td><img src=\"../../".$dados['culturalURL']."\"></td>";
           ...
           echo "<td class= 'actions' >";
            ...
            echo  "<a class='btn btn-success btn-xs' href='listaslideshow.php'><i class='fa fa-eye'></i> Slideshow </a>";
                  ...
                  echo  " <a class='btn btn-warning btn-xs  justify-content-md-end'href=\"../editar/editaCultural.php?id=".$dados["culturalId"]."\"><i class='fa fa-pencil'></i>Editar</a>";
