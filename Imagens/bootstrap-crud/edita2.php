...
?>
    <section class="store" style="padding:50px">
        <a href="testerest.php"><button type="button" class="btn btn-danger">Voltar</button></a>
        <hr>
        <form action="confirmaEditaEstabelecimento.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
            ...
            <input type="text"  name="imagemOrdem" value="<?php echo $dadosImagens["imagemOrdem"]?>"><hr>
