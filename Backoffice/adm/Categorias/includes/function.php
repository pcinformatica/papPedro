      ...
      <tbody>
        ...
        while ($dados=mysqli_fetch_array($result)) {
           ...
           echo "<td class= 'actions' >";
                  ...
                  echo  " <a class='btn btn-warning btn-xs  justify-content-md-end'href=\"editacategoria.php?id=".$dados["categoriaId"]."\"><i class='fa fa-pencil'></i>Editar</a>";
    ...
    <script>
        function confirmaElimina(id) {
            if(confirm('Confirma que deseja eliminar o registo?'))
                window.location="../Categorias/eliminaCategoria.php?id=" + id;
        }
